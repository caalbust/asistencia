...
class __TwigTemplate_837134e721bd78ba39bf4fae6ee8e0a66730127acc9ee9d68c76d624842023a7 extends Twig_Template
{
...
($context["collector"] ?? null), "symfonyState", array()))) {
                // line 15
...
($context["collector"] ?? null), "symfonyState", array()))) {
    ...
    ";
        ...
        // line 72
        echo twig_escape_filter($this->env, ($context["debug_status_class"] ?? null), "html", null, true);
        echo "\"> </span>
        ...
        ";
        // line 74
        if ((("n/a" != $this->getAttribute(($context["collector"] ?? null), "appname", array())) || ("n/a" != $this->getAttribute(($context["collector"] ?? null), "env", array())))) {
            // line 75
        ...
        if (("n/a" != $this->getAttribute(($context["collector"] ?? null), "debug", array()))) {
            ...
            echo twig_escape_filter($this->env, ($context["debug_status_class"] ?? null), "html", null, true);
            echo "\">";
            echo (($this->getAttribute(($context["collector"] ?? null), "debug", array())) ? ("en") : ("dis"));
            echo "abled</span>
                </div>
            ";
        }
        ...
        // line 113
        echo "    ";
        $this->loadTemplate("@WebProfiler/Profiler/toolbar_item.html.twig", "@WebProfiler/Collector/config.html.twig", 113)->display(array_merge($context, array("link" => ($context["profiler_url"] ?? null))));
    }
...
";
    ...
    {
        return new Twig_Source("", "@WebProfiler/Collector/config.html.twig", "C:\\wamp64\\www\\asistenciaFIECCAS\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle\\Resources\\views\\Collector\\config.html.twig");
    }
}
