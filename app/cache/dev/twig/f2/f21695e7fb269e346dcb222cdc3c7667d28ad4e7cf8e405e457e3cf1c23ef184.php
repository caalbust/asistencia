...
class __TwigTemplate_a413d971b93388846cf90e05dc862ac249051ead4705a3afdce886a5eae80a31 extends Twig_Template
{
    ...
    ";
        ...
        if (twig_length_filter($this->env, $this->getAttribute($this->getAttribute(($context["collector"] ?? null), "data", array()), "forms", array()))) {
            ...
            foreach ($context['_seq'] as $context["formName"] => $context["formData"]) {
                // line 194
                echo "                ";
                echo $context["__internal_fcc0829c0fa32ade41364f2d9f2f29193361d5431a714dca5f8ab6fb9e1ec028"]->getform_tree_details($context["formName"], $context["formData"], $this->getAttribute($this->getAttribute(($context["collector"] ?? null), "data", array()), "forms_by_hash", array()));
                echo "
            ";
            }
            $_parent = $context['_parent'];
...
$context["trace"], "message", array(), "any", true, true)) {
    ...
    {
        return new Twig_Source("", "@WebProfiler/Collector/form.html.twig", "C:\\wamp64\\www\\asistenciaFIECCAS\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle\\Resources\\views\\Collector\\form.html.twig");
    }
}
