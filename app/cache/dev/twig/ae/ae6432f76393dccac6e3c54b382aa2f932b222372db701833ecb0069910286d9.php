...
class __TwigTemplate_2a822e03bf79e5d32036d0ed20e7b97fff353048c4cffcd6a59f8e2a5340c220 extends Twig_Template
{
    ...
    public function block_toolbar($context, array $blocks = array())
    {
        ...
        if ($this->getAttribute($this->getAttribute(($context["collector"] ?? null), "controller", array(), "any", false, true), "class", array(), "any", true, true)) {
            ...
            if ($this->getAttribute($this->getAttribute(($context["collector"] ?? null), "controller", array()), "method", array())) {
                ...
                echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\CodeExtension')->abbrClass($this->getAttribute($this->getAttribute(($context["collector"] ?? null), "controller", array()), "class", array()));
                echo "</span>
                <span class=\"sf-toolbar-info-method\"";
                // line 9
                if (($context["link"] ?? null)) {
                    echo " onclick=\"window.location='";
                    echo twig_escape_filter($this->env, twig_escape_filter($this->env, ($context["link"] ?? null), "js"), "html", null, true);
        ...
        // line 25
        echo twig_escape_filter($this->env, ($context["request_route"] ?? null), "html", null, true);
        echo "</i></span>
    ";
        ...
        // line 47
        echo "    ";
        $this->loadTemplate("@WebProfiler/Profiler/toolbar_item.html.twig", "@WebProfiler/Collector/request.html.twig", 47)->display(array_merge($context, array("link" => ($context["profiler_url"] ?? null))));
    }
...
";
    ...
    ";
        // line 60
        if (twig_length_filter($this->env, $this->getAttribute($this->getAttribute(($context["collector"] ?? null), "requestquery", array()), "all", array()))) {
            // line 61
            echo "        ";
            $this->loadTemplate("@WebProfiler/Profiler/bag.html.twig", "@WebProfiler/Collector/request.html.twig", 61)->display(array("bag" => $this->getAttribute(($context["collector"] ?? null), "requestquery", array())));
            // line 62
            echo "    ";
        } else {
            // line 63
    ...
    ";
        // line 70
        if (twig_length_filter($this->env, $this->getAttribute($this->getAttribute(($context["collector"] ?? null), "requestrequest", array()), "all", array()))) {
            // line 71
            echo "        ";
            $this->loadTemplate("@WebProfiler/Profiler/bag.html.twig", "@WebProfiler/Collector/request.html.twig", 71)->display(array("bag" => $this->getAttribute(($context["collector"] ?? null), "requestrequest", array())));
            // line 72
            echo "    ";
        } else {
            // line 73
    ...
    ";
        // line 80
        if (twig_length_filter($this->env, $this->getAttribute($this->getAttribute(($context["collector"] ?? null), "requestattributes", array()), "all", array()))) {
            // line 81
            echo "        ";
            $this->loadTemplate("@WebProfiler/Profiler/bag.html.twig", "@WebProfiler/Collector/request.html.twig", 81)->display(array("bag" => $this->getAttribute(($context["collector"] ?? null), "requestattributes", array())));
            // line 82
            echo "    ";
        } else {
            // line 83
    ...
    ";
        // line 90
        if (twig_length_filter($this->env, $this->getAttribute($this->getAttribute(($context["collector"] ?? null), "requestcookies", array()), "all", array()))) {
            // line 91
            echo "        ";
            $this->loadTemplate("@WebProfiler/Profiler/bag.html.twig", "@WebProfiler/Collector/request.html.twig", 91)->display(array("bag" => $this->getAttribute(($context["collector"] ?? null), "requestcookies", array())));
            // line 92
            echo "    ";
        } else {
            // line 93
    ...
    ";
        // line 100
        $this->loadTemplate("@WebProfiler/Profiler/bag.html.twig", "@WebProfiler/Collector/request.html.twig", 100)->display(array("bag" => $this->getAttribute(($context["collector"] ?? null), "requestheaders", array())));
        // line 101
        echo "
...
($context["collector"] ?? null), "content", array())) {
    ...
    ";
        // line 114
        $this->loadTemplate("@WebProfiler/Profiler/bag.html.twig", "@WebProfiler/Collector/request.html.twig", 114)->display(array("bag" => $this->getAttribute(($context["collector"] ?? null), "requestserver", array())));
        // line 115
        echo "
    ...
    ";
        // line 118
        $this->loadTemplate("@WebProfiler/Profiler/bag.html.twig", "@WebProfiler/Collector/request.html.twig", 118)->display(array("bag" => $this->getAttribute(($context["collector"] ?? null), "responseheaders", array())));
        // line 119
        echo "
    ...
    ";
        ...
        if (twig_length_filter($this->env, $this->getAttribute(($context["collector"] ?? null), "sessionmetadata", array()))) {
            // line 123
            echo "    ";
            $this->loadTemplate("@WebProfiler/Profiler/table.html.twig", "@WebProfiler/Collector/request.html.twig", 123)->display(array("data" => $this->getAttribute(($context["collector"] ?? null), "sessionmetadata", array())));
            // line 124
            echo "    ";
        } else {
            // line 125
    ...
    ";
        // line 132
        if (twig_length_filter($this->env, $this->getAttribute(($context["collector"] ?? null), "sessionattributes", array()))) {
            // line 133
            echo "        ";
            $this->loadTemplate("@WebProfiler/Profiler/table.html.twig", "@WebProfiler/Collector/request.html.twig", 133)->display(array("data" => $this->getAttribute(($context["collector"] ?? null), "sessionattributes", array())));
            // line 134
            echo "    ";
        } else {
            // line 135
    ...
    ";
        // line 142
        if (twig_length_filter($this->env, $this->getAttribute(($context["collector"] ?? null), "flashes", array()))) {
            // line 143
            echo "        ";
            $this->loadTemplate("@WebProfiler/Profiler/table.html.twig", "@WebProfiler/Collector/request.html.twig", 143)->display(array("data" => $this->getAttribute(($context["collector"] ?? null), "flashes", array())));
            // line 144
            echo "    ";
        } else {
            // line 145
    ...
    ";
        ...
        ";
            // line 153
            $this->loadTemplate("@WebProfiler/Profiler/bag.html.twig", "@WebProfiler/Collector/request.html.twig", 153)->display(array("bag" => $this->getAttribute($this->getAttribute($this->getAttribute(($context["profile"] ?? null), "parent", array()), "getcollector", array(0 => "request"), "method"), "requestattributes", array())));
            // line 154
            echo "    ";
        }
        // line 155
...
";
    ...
    {
        return new Twig_Source("", "@WebProfiler/Collector/request.html.twig", "C:\\wamp64\\www\\asistenciaFIECCAS\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle\\Resources\\views\\Collector\\request.html.twig");
    }
}
